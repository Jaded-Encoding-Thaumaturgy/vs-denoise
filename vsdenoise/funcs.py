...
def mlm_degrain(
    ...
    then a normal MVTools Degrain can produce a very stable result.
    The approach here is to first make a small-but-stable-denoised clip,
    then work the way upwards to the original resolution, averaging their differences.
    ...
    :param factors:             Factors of scalings to do.
                                 * If floats, they will be interpreted as size * factor.
                                 * If a range, it will first be normalized as a list of float with 1 / factor.
    :param scaler:              Scaler to use for scaling up the downscaled clips when diffing them.
    :param downscaler:          Scaler to use for downscaling the clip to the various levels.
    ...
    :param merge_func:          Custom merge function for the last stage of the function.
                                Two difd clips generated by `core.std.MakeDiff` will be passed, so they will be shifted.
